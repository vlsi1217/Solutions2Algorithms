...
//DeluxeBFS is based on BreadthFirstDirectedPaths.\
//one method is added: destinations()
public class DeluxeBFS {
    ...
    // return all vertices that can be reached
    public Iterable<Integer> destinations() {
    	SET<Integer> parents = new SET<Integer>();
